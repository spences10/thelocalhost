...
I'm talking Fathom Analytics again, this time about tracking custom
events.
...
In the Markdown add the goal ID to the URL:
...
On line 3 I'm checking if the `props.href` contains a `goalId`
parameter.
...
In this video I detail what I've been writing about.
...
[track custom events]:
  https://thelocalhost.blog/2020/01/02/track-custom-events-with-fathom-analytics/
