...
The content (headings, paragraphs, etc.) was reset in the template
being used.

I'm going to add components for headings and paragraphs.
...
`remark-slug` `gatsby-remark-autolink-headers`
