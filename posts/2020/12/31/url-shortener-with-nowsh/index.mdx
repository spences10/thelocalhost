...
![zeit project overview](./zeit-project-overview.png)
...
That's it the project is now on GitHub and I can start using the ZEIT
GitHub integration.
...
The ZEIT documentation for this is really good so I'm going to link
that [here].

Now each time I add a short url to my project all I have to do is git
commit and push to GitHub and the ZEIT GitHub integration will take
care of the rest.

## Add my domain to ZEIT

Now I'm going to add my own domain to ZEIT from the 'Settings' panel
of my project I can select 'Domains' and add in my own domain.

My domain isn't supplied by ZEIT so I will need to configure the DNS
settings in my domain provider by adding the custom DNS configuration
supplied here by ZEIT.

![zeit domains settings](./zeit-domains-settings.png)

The cool thing with ZEIT is that I can have many domains pointing to
the same project.
...
[here]: https://zeit.co/docs/v2/git-integrations/zeit-now-for-github
