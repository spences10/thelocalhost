...
published: true
cover: ./cover.jpg
coverCredit: Photo by Renee Fisher on Unsplash
---
...
have a specific domain provider and I'm using Zeit's now.sh and
...
## Add DNS record in Zeit's now.sh
...
found the [DNS Editor for ZEIT domains] which Jack mentioned in the
reply to my tweet! 🤦‍♂

It's a free integration on the ZEIT Marketplace which is super
straightforward to use once you add it to your zeit account you can
pick it from the Integrations section on your ZEIT Dashboard.
...
![pick custom domain in site settings](./pick-custom-domain-in-site-settings.png)
...
It didn't take long to validate the record in the Fathoms setting page
...
[dns editor for zeit domains]: https://zeit.co/integrations/dns
